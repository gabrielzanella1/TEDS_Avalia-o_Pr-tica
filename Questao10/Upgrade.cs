public class Upgrade {
    ...
    public Upgrade(string Destino, bool Disponivel){
    ...
    public bool ReservarVoo(){
        if(Verificar()){
            Console.WriteLine($"Sua viagem para {Destino} esta disponível para reserva com Upgrade!");
            Console.WriteLine($"Viagem com destino a {Destino} efetuada!");
            return Reservada = true;
        }else {
            Console.WriteLine($"Sua viagem para {Destino} nao esta disponível para reserva com Upgrade!");
            Console.WriteLine("Reserva com Upgrade Pendente.");
    ...
    public void StatusReserva(){
        if(Reservada){
            Console.WriteLine("Reserva com Upgrade efetuada!");
        }else {
